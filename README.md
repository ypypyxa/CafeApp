...
3. Создать файл `developer.properties` в корне проекта, вставить туда строчку с вашим ключем для Яндекс.Mapkit вида `MAPKIT_API_KEY = YOUR_API_KEY` и собрать проект
